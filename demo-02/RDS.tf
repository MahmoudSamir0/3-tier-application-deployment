module "RDS_DATABASE" {
  ...
  secondary_subnet-id = module.network.RDS_private_subnet_ip_az2
  subnet_group_name_secondary ="secondary_subnet"
  subnet_group_name_primary ="primary_subnet"
  rds_db_admin = "admin"
  rds_db_password = "password"
  db_name = "primary"
  # db_name_secondary= "secondary"
  engine_version = "5.7"
  ...
  identifier_secondary = "secondarydatabase"
}
